...
INSERT INTO employees (first_name, last_name, department_id, job_title, date_of_birth)
VALUES ('Nina', 'Kravchuk', '123', 'manager', '2003-02-13'),
       ('Mikhail', 'Ivanchenko', '124', 'sales', '1986-09-20'),
       ('Andrei', 'Filimonov', '124', 'sales', '1997-11-17');